...
class NavBarController extends GetxController {
  ...
  RxList<Category> availableCatagory = <Category>[
    ...
    Category(
      ...
      color: Colors.cyan,
      txtColor: const Color.fromARGB(255, 237, 122, 255),
  ...
  RxList<Meal> avaiableMeals = <Meal>[
  ...
  RxList<Meal> favouriteMeal=<Meal> [].obs;
  Rx<bool> toogleMealFavouriteStatus(Meal meal){
 
   final mealisFavourite= favouriteMeal.contains(meal);
   if (mealisFavourite) {
     // Remove
  favouriteMeal.value= favouriteMeal.where((m) => m.id != meal.id).toList();
  return false.obs;
   } else {
      favouriteMeal.value=[...favouriteMeal,meal];
      return true.obs;
   }
